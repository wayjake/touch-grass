...
// Dialog state
static const DialogPage* currentDialog = NULL;
...
static const DialogPage spiritDialog[] = {
    { SPEAKER_SPIRIT, "Greetings,", "wanderer...", NULL },
    ...
    { SPEAKER_SPIRIT, "The world", "beyond awaits...", NULL }
};
...
static bool isDialogActive() {
    return currentDialog != NULL && dialogPageIndex < dialogPageCount;
}
