 ...
 * Platform Layer
 *
 * API for display, input, sound, and timing. Implemented by
 * platform_terminal.c, which renders the 128x64 monochrome framebuffer
 * in the terminal.
 */
...
// tileData: 8 bytes, one per row, MSB-first bit ordering
...
// Returns true once the user has requested quit (Q / Ctrl+C)
